...
![ภาพหน้าจอ Login](../05_Testing/Test_Evidence/TC-01_Login_Success.png)
...
* **สถานะ (Status):** บอกเกณฑ์รูปร่างของคุณ ซึ่งจะมีสีแตกต่างกัน:
    * 🔵 **สีน้ำเงิน:** ผอมมาก / ผอม
    * 🟢 **สีเขียว:** ปกติ (สมส่วน)
    * 🟡 **สีเหลือง:** น้ำหนักเกิน
    * 🟠 **สีส้ม:** อ้วน
    * 🔴 **สีแดง:** อ้วนมาก
* **คำแนะนำเบื้องต้น (Recommended):** ข้อความสรุปสั้นๆ เกี่ยวกับการดูแลตนเอง
